...
function Search(props: SearchProps) {
    return (
        <div class="relative border-b border-white/20 w-full shrink-0">
            <div class="relative w-full">
                <input
                    ...
                    spellcheck="false"
                    autocomplete="off"
                    class="w-full h-12 pl-4 pr-24 text-white/90 placeholder-white/40 bg-transparent border-none focus:ring-0 focus:outline-none font-light"
                />
